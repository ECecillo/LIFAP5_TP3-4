...
// 3 - on rajoute 1 à chaque mois dans le tableau. (pas possible)
// 4 - On applique au tableau la fonction elimine_doublon
...
// cela nous renvoie cette chaine de caractères où on récupère les années que l'on met deans l'ordre croissant et on supprime également les doublons.
// Enfin on affiche sur une page html la chaine de caractères annee_html à l'endroit où l'on a déclaré select annee en ID. ce qui nous donne une liste de date.
...
function init_menus() {
  ...
  maj_annees(charge_donnees(nouvellesUrl, maj_annees));
